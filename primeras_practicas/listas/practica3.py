...
print(f"la cantidad de elementos es {len(paises)}")
print(f"los dos unltimos paises de esta lista son {paises[-2]} y {paises[-1]}")
print(f"Brazil se encuentra en la posicion {paises.index("Brazil")}") 
